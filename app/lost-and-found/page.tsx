                ...
                <div key={item.id} className="brand-panel animate-enter-soft p-0 overflow-hidden group flex flex-col transition-all hover:border-white/20 hover:shadow-[0_8px_30px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex justify-between items-start mb-2">
                       <h3 className="text-[17px] font-black tracking-wide text-white group-hover:text-accent-blue transition-colors truncate pr-2">
                        {item.title}
                      </h3>
                    ...
                    {activeTab === "feed" && (
                      <button className={cn("w-full mt-6 h-11 text-xs font-bold uppercase tracking-widest rounded-xl border transition-all duration-200 flex items-center justify-center gap-2", item.type === 'found' ? 'bg-accent-blue border-accent-blue/50 text-white hover:bg-blue-600 hover:shadow-[0_0_20px_rgba(37,99,235,0.4)]' : 'bg-white/5 border-white/10 text-white hover:bg-white/10 hover:border-white/20')}>
